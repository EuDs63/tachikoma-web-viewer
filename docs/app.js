...
const models = {
  walk: { src: "assets/tachikoma-walk.glb", label: "步行姿态", animated: false },
  roll: { src: "assets/tachikoma-roll.glb", label: "轮式姿态", animated: false },
  patrol: { src: "assets/tachikoma-patrol.glb", label: "巡逻动画", animated: true },
};
