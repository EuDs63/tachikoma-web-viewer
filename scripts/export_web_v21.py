"""Export Tachikoma v21 front-optic-repaired browser GLB assets.

Run with Blender in background mode while opening
``tachikoma_v21_optic_mounted.blend``.
"""
...
report_path = os.path.join(ROOT, "audit", "web_export_v21.json")
...
print("WEB_EXPORT_V21=" + json.dumps(exports), flush=True)
